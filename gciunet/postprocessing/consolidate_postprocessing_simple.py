...
import argparse
from gciunet.postprocessing.consolidate_postprocessing import consolidate_folds
from gciunet.utilities.folder_names import get_output_folder_name
from gciunet.utilities.task_name_id_conversion import convert_id_to_task_name
from gciunet.paths import default_cascade_trainer, default_trainer, default_plans_identifier
...
def main():
    ...
    argparser.add_argument("-tr", type=str, required=False, default=None,
                           help="gci_unetTrainer class. Default: %s, unless 3d_cascade_fullres "
    ...
    if trainer is None:
        if model == "3d_cascade_fullres":
            trainer = "gci_unetTrainerV2CascadeFullRes"
        else:
            trainer = "gci_unetTrainerV2"
