...
def get_commands(configurations, regular_trainer="gci_unetTrainerV2", cascade_trainer="gciunetTrainerV2CascadeFullRes",
                 plans="gci_unetPlansv2.1"):
    ...
    for task in configurations:
        ...
        for m in models:
            ...
            folder = get_output_folder_name(m, task, trainer, plans, overwrite_training_output_dir="/datasets/datasets_fabian/results/GCI_UNet")
