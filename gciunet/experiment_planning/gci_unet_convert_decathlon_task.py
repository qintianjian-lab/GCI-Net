...
from gciunet.experiment_planning.utils import split_4d
from gciunet.utilities.file_endings import remove_trailing_slash
...
def main():
    ...
    parser.add_argument("-i", help="Input folder. Must point to a TaskXX_TASKNAME folder as downloaded from the MSD "
                        ...
                        default="/srv/qiaoqiang/m1/DATASET_Tumor/m1_raw/m1_raw_data"
                                "/Task02_Synapse")
