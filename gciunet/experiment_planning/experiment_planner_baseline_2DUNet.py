...
from gciunet.experiment_planning.common_utils import get_pool_and_conv_props
from gciunet.experiment_planning.experiment_planner_baseline_3DUNet import ExperimentPlanner
from gciunet.experiment_planning.utils import add_classes_in_slice_info
from gciunet.network_architecture.brats.generic_UNet import Generic_UNet
from gciunet.paths import *
from gciunet.preprocessing.preprocessing import PreprocessorFor2D
...
class ExperimentPlanner2D(ExperimentPlanner):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(self.preprocessed_output_folder, "gci_unetPlans" + "_plans_2D.pkl")
