...
from gciunet.configuration import default_num_threads
from gciunet.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
from gciunet.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from gciunet.experiment_planning.utils import create_lists_from_splitted_dataset
from gciunet.network_architecture.brats.generic_UNet import Generic_UNet
from gciunet.paths import *
from gciunet.preprocessing.cropping import get_case_identifier_from_npz
from gciunet.training.model_restore import recursive_find_python_class
...
class ExperimentPlanner(object):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(self.preprocessed_output_folder, "gci_unetPlans" + "fixed_plans_3D.pkl")
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([join(gciunet.__path__[0], "preprocessing")],
                                                         self.preprocessor_name, current_module="gciunet.preprocessing")
...
if __name__ == "__main__":
    ...
    for i in task_ids:
        i = int(i)
        candidates = subdirs(gci_unet_cropped_data, prefix="Task%03.0d" % i, join=False)
    ...
    for t in tasks:
        try:
            print("\n\n\n", t)
            cropped_out_dir = os.path.join(gci_unet_cropped_data, t)
            preprocessing_output_dir_this_task = os.path.join(preprocessing_output_dir, t)
            splitted_4d_output_dir_task = os.path.join(gci_unet_raw_data, t)
            ...
            shutil.copy(join(gci_unet_raw_data, t, "dataset.json"), preprocessing_output_dir_this_task)
