...
from gciunet.network_architecture.generic_modular_residual_UNet import FabiansUNet
...
class ExperimentPlanner3DFabiansResUNet_v21(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "GCIUNetData_plans_v2.1"# "nnFormerData_FabiansResUNet_v2.1"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "GCIUNetPlans_FabiansResUNet_v2.1_plans_3D.pkl")
