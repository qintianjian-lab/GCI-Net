...
from gciunet.network_architecture.generic_UNet import Generic_UNet
...
class ExperimentPlanner3D_IsoPatchesInVoxels(ExperimentPlanner):
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "GCIUNetData_isoPatchesInVoxels"
        self.plans_fname = join(self.preprocessed_output_folder, "GCIUNetPlans" + "fixedisoPatchesInVoxels_plans_3D.pkl")
