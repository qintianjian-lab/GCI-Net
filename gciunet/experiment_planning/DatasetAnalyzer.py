...
from gciunet.paths import gci_unet_raw_data, gci_unet_cropped_data
import numpy as np
import pickle
from gciunet.preprocessing.cropping import get_patient_identifiers_from_cropped_files
