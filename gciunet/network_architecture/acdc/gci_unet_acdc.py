...
from gciunet.network_architecture.acdc.model_components import GCIUNetEncoder, GCIUpBlock, LastGCIUpBlock
import torch
...
class GCI_UNet(SegmentationNetwork):
    ...
    def forward(self, x_in):
        ...
        # Four encoders
        enc1 = hidden_states[0] # torch.Size([4, 32, 16, 40, 40]) 
        enc2 = hidden_states[1] # torch.Size([4, 64, 8, 20, 20]) 
        enc3 = hidden_states[2] # torch.Size([4, 128, 4, 10, 10]) 
        enc4 = hidden_states[3] # torch.Size([4, 50, 256]) 
