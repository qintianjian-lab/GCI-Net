...
from gciunet.inference.segmentation_export import save_segmentation_nifti_from_softmax, save_segmentation_nifti
...
from gciunet.postprocessing.connected_components import load_remove_save, load_postprocessing
from gciunet.training.model_restore import load_model_and_checkpoint_files
from gciunet.training.network_training.Trainer_tumor import Trainer_tumor
from gciunet.training.network_training.Trainer_acdc import Trainer_acdc

#from gciunet.training.network_training.Trainer_synapse import Trainer_synapse
...
def preprocess_multithreaded(trainer, list_of_lists, output_files, num_processes=2, segs_from_prev_stage=None):
    ...
    assert isinstance(trainer, Trainer_tumor) or isinstance(trainer, Trainer_acdc) or isinstance(trainer, Trainer_synapse)
