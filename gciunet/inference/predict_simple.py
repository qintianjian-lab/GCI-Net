...
from gciunet.inference.predict import predict_from_folder
from gciunet.paths import default_plans_identifier, network_training_output_dir,  default_trainer
...
def main():
    ...
    parser.add_argument('-tr', '--trainer_class_name',
                        help='Name of the gci_unetTrainer used for 2D U-Net, full resolution 3D U-Net and low resolution '
    ...
    parser.add_argument('-z', '--save_npz', required=False, action='store_true',
                        help="use this if you want to ensemble these predictions with those of other models. Softmax "
                             ...
                             "merged between output_folders with gci_unet_ensemble_predictions")
