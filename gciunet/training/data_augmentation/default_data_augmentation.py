...
from gciunet.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform
from gciunet.training.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
...
default_3D_augmentation_params = {
    ...
    "num_threads": 12 if 'gci_unet_n_proc_DA' not in os.environ else int(os.environ['gci_unet_n_proc_DA']),
...
if __name__ == "__main__":
    from gciunet.training.dataloading.dataset_loading import DataLoader3D, load_dataset
    from gciunet.paths import preprocessing_output_dir
    import os
    import pickle
