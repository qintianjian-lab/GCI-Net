...
from gciunet.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(gciunet.__path__[0], "training", "network_training"),
                              base_module='gciunet.training.network_training'):
    ...
    print("###############################################")
    print("I am running the following gci_unet: %s" % network)
